...
(async () => {
  ...
  await fs.writeFile("gastritis-and-duodenitis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("gastritis-and-duodenitis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
